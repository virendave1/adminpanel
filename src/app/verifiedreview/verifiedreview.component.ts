...
@Component({
  selector: 'app-verifiedreview',
  templateUrl: './verifiedreview.component.html',
  styleUrls: ['./verifiedreview.component.css']
})
export class VerifiedreviewComponent implements OnInit {
